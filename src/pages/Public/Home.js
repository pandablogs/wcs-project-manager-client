    ...
    <>
      ...
      <Navbar expand="lg" className="Navbarsection bg-light fixed-top">
        <Container>
          <Navbar.Brand className="navbar-custom" href="#">
            <img src={LogoV1} alt="logo" className="img-custom" />
          </Navbar.Brand>
      ...
      <section className="hero-section">
        <Container className="text-center text-white ">
          ...
          <Button
            className="btnhero fw-bold rounded-pill py-3 px-4 border-0"
            onClick={() => navigate("/project-estimater")}
          >
            Get Your Estimate
          </Button>
            ...
            <Row className="justify-content-center mb-5">
              <Col md={8}>
                ...
                <p>
                  ...
                  Curabitur Quis Volutpat Nibh. Ut Mattis Ante Et Magna
                  Eleifend, Quis Aliquam Dui Vestibulum. Suspendisse Eget Massa
                  Vehicula.
                </p>
              </Col>
            </Row>
              ...
              <Col className="justify-content-center">
                <Card className="card">
                  <Card.Body>
                    ...
                    <Card.Title className="cardheding fw-bold my-3">
                      PRE-LISTING SELLER’S INSPECTIONS
                    </Card.Title>
                    <Card.Text className="text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      In a augue non ante vulputate aliquet. Quisque in tellus
                      eu magna rhoncus scelerisque. Vivamus dolor ligula.
                    </Card.Text>
                  </Card.Body>
                </Card>
              </Col>
        ...
        <div className="about1">
          <Container>
            <Row>
              {/* Left Side Image */}
              <Col md={6}>
                <img src={about1} alt="" className="about1-image" />
              </Col>
              ...
              <Col md={6} className="mt-3">
                ...
                <h2 className="heading fw-bold">
                  WE ARE <span className="text-warning">PROFESSIONAL</span>{" "}
                  <br />
                ...
                <p className="description">
                  ...
                  non quaerat recusandae consequuntur sit nam atque perferendis
                  laborum perspiciatis tempore ullam earum id, doloribus
                  incidunt ipsa nostrum, obcaecati aliquid consectetur quos esse
                  porro, quidem at. Et aspernatur dicta alias quae asperiores
                  nisi beatae ad, adipisci est recusandae! Libero, suscipit
                  quis.
                </p>
                <br />
                <p className="description">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Quaerat perferendis neque ad qui inventore tenetur, quo magni
                  aliquid enim corporis accusamus dolore? Veniam, cumque
                  repellendus.
                </p>
              </Col>
            </Row>
            ...
            <Row className="mt-5 icon">
              <Col md={3} className="d-flex gap-3">
                ...
                <div className="iconcontain">
                  ...
                  <p className="fw-bold">INSPECTIONS</p>
                </div>
              </Col>
              <Col md={3} className="d-flex gap-3">
                <div>
                ...
                <div className="iconcontain">
                  ...
                  <p className="fw-bold">INSPECTORS</p>
                </div>
              </Col>
              <Col md={3} className="d-flex gap-3">
                <div>
            ...
            <Row>
              ...
              <Col md={6}>
                ...
                <h2 className="heading">
                  WE ARE PROFESSIONAL THAT
                  <br />
                  MAKE <span className="text-warning">CLIENTS HAPPY.</span>{" "}
                  <br />
                </h2>
                <br />
                <p className="description">
              ...
              {/* right Side Image */}
              <Col md={6}>
                <img src={about2} alt="" className="about2-image" />
              </Col>
            </Row>
          </Container>
        </div>
            ...
            <Row className="justify-content-center text-white">
              <Col md={8}>
                ...
                <h2 className="my-5 fw-bold">
                  ...
                  <span className="text-warning">INSPECTION</span> SERVICES.
                </h2>
                <button
                  type="button"
          ...
          <Container className="text-center py-5">
            <Row className="justify-content-center">
              <Col md={8}>
                ...
                <h2 className="fw-bold">
                  CHECK WHAT'S OUR{" "}
                  <span className="text-warning">CLIENTS SAID</span>
                </h2>
              </Col>
            </Row>
          </Container>
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              ...
              <p className="pt-3 pb-5">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Laboriosam facere expedita eaque cupiditate excepturi modi
                officia minima, blanditiis ullam. Ducimus deleniti ex sunt
          ...
          <Row className="justify-content-center ">
            <Col md={8}>
              <Form>
                ...
                <Row>
                  <Button type="submit" className="btnform border rounded-pill">
                    SEND MESSAGE
                  </Button>
                </Row>
              </Form>
      ...
      <footer className="bg-dark text-white py-5">
        <Container>
          <Row>
              ...
              <div className="footer_logo-container">
                <Link to="/" className="brand brand-footer">
                  <img
                    src={LogoV1}
                    alt="QuickLending"
                    title="QuickLendingLogo-NoTagline"
                    className="img-fluid"
            ...
            <Col lg={9}>
              <Row>
                {/* WCS Property Solutions */}
                <Col lg={4} className="pt-4">
                  <h6
                    className="text-color-gold mb-3"
                    style={{
                      borderBottom: "0.5px solid rgb(217, 180, 81)",
                      fontWeight: 600,
                      fontSize: "18px",
                    }}
                  >
                ...
                {/* <Col lg={4} className="pt-4">
                  ...
                  <div className="footer_link-wrapper">
                    <Link to="/about" className="footer-link d-block">
                      About Us
                    </Link>
                    <Link to="/services" className="footer-link d-block">
                      Services
                    </Link>
                    <Link to="/faq" className="footer-link d-block">
                      FAQ
                    </Link>
                    <Link to="/contact" className="footer-link d-block">
                      Contact Us
                    </Link>
                    <Link to="/login/admin" className="footer-link d-block">
                      Company Portal
                    </Link>
                  </div>
                </Col> */}
                ...
                {/* <Col lg={4} className="pt-4">
                  ...
                  <div className="footer_link-wrapper">
                    <span className="footer-link d-block">Colorado</span>
                    <span className="footer-link d-block">Ohio</span>
                    <span className="footer-link d-block">Tennessee</span>
                    <span className="footer-link d-block">Oklahoma</span>
                  </div>
                </Col> */}
              </Row>
            </Col>
